...
export default function Background() {
  ...
  return (
    <section id="background" data-section="background" className="py-20 px-6">
            ...
            <div className="bg-orange-50 rounded-2xl p-6 border border-orange-100">
              <p className="text-stone-700 text-sm leading-relaxed">
                {t(
                  ...
                  'Frontend Engineer with 2 years of experience at Knowlecy (Canada) and Microsoft. Specialized in React/Next.js full-stack development with strong focus on component architecture, state management, and performance optimization.'
                )}
              </p>
            </div>
          </div>
